...
interval = 0.25 # interval of checking and plotting values (in seconds)
...
def drawPoints(img, points):
    for point in points:
         cv2.circle(img, point, 5, (0, 0, 255), cv2.FILLED) # The image is BGR (in opencv we don't say RGB; we say BGR)
